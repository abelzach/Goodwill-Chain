...
const NavBar = () => {
  return (
    <nav className="w-full py-4 sm:py-6 border-b-2 sm:border-0 border-gray-200 sm:shadow-md bg-green-600" style={{opacity:0.75}}>
      <img
        className="h-24 sm:h-32 w-24 sm:w-32 mx-auto rounded-full object-contain"
        src={images.logo}
        alt="Company logo"
      /><br/>
      <p className="" style={{color:"#fff", textAlign:"center"}}>The New Civilsation Money Exchange Forum</p>
